...
namespace Assignment2.BottomLayerPersistenceLogic
{
    public class StudentHelperContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            { HelpWhere = "Benjamin", Lecture = 1, Number = 1, TeacherAUID = "au555555", CourseID = 1 });
            modelBuilder.Entity<Exercise>().HasData(new Exercise
            { HelpWhere = "Benjamin", Lecture = 1, Number = 2, TeacherAUID = "au666666", CourseID = 2 });
            modelBuilder.Entity<Exercise>().HasData(new Exercise
            { HelpWhere = "Benjamin", Lecture = 1, Number = 3, TeacherAUID = "au777777", CourseID = 3 });
            ...
            { ExerciseLecture = 1, ExerciseNumber = 1, StudentAUID = "au111111", CourseId = 1 });
            modelBuilder.Entity<StudentExercise>().HasData(new StudentExercise
            { ExerciseLecture = 1, ExerciseNumber = 2, StudentAUID = "au222222", CourseId = 2 });
            modelBuilder.Entity<StudentExercise>().HasData(new StudentExercise
            { ExerciseLecture = 1, ExerciseNumber = 3, StudentAUID = "au333333", CourseId = 3 });
